        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-20 max-w-full px-4 xl:mr-12">
              ...
              >
                <div className="relative h-14 w-14 overflow-hidden rounded-full border-2 border-[#0EA5E9] bg-[#101722] shadow-[0_0_22px_rgba(14,165,233,.35)]">
                  <Image
                    src="/images/logo/nexo.jpg"
                    alt="NEXOS"
                    width={220}
                    height={300}
                    className="h-full w-full scale-[2.45] object-cover object-[50%_28%]"
                    priority
                  />
                </div>
              </Link>
